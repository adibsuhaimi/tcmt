                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    @foreach ($tc as $tc)
                                        <tr>
                                            ...
                                            @if($tc->testresultstatus === 'Fail' && $tc->testresultvisible == 1)
                                                <td><button class="btn btn-primary" type="button" onclick="document.location='/testresults/{{$tc->testresultid}}/edit'">Fix Defect</td>
                                            @else
