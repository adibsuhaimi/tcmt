        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <div class="container-fluid" style="width: 1000px;">
                    <h3 class="text-dark mb-4">Fix Defect</h3>
            ...
            <div id="content">
                <div class="container-fluid" style="width: 1000px;">
                    <div class="card shadow mb-5">
                        ...
                        @csrf
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea readonly class="form-control" rows="6" name="testresultcomment">{{ $tr->testresultcomment}}</textarea>
                                    </div>
                                </div>
                                </div>
                        ...
                        <div class="card-header py-3">
                        <button class="btn btn-primary" type="submit" onclick="return confirm('Are you sure the bug is fix ?')">Fix Defect</button>
