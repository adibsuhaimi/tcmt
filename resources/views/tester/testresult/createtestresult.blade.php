        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <div class="container-fluid" style="width: 1000px;">
                    <h3 class="text-dark mb-4">Add Test Result</h3>
                        ...
                        <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <a href="{{ asset('uploads/file/'. $tc->testcasefile) }}">{{ $tc->testcasefile }}</a></div>
                                    </div>
                                </div>
            ...
            <div id="content">
                <div class="container-fluid" style="width: 1000px;">
                    <div class="card shadow mb-5">
                        ...
                        <div class="card-body">
                        <form method="POST" action="{{ route('testresults.storetr', $tc->testcaseid) }}" enctype="multipart/form-data">
                        @csrf
                            <div class="form-row">
                                <div class="col">
                                        <div class="form-group"><label for="testresultreference"><strong>ID</strong></label>
                                        <input id="testresultreference" type="text" class="form-control @error('testresultreference') is-invalid @enderror" name="testresultreference" value="" autofocus>
                                    
                                    @error('testresultreference')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror</div>
                                    ...
                                    <div class="col">
                                        <div class="form-group"><label for="testresultstatus"><strong>Priority</strong></label><div class="input-group">
                                            <select id="testresultstatus" class="form-control @error('testresultstatus') is-invalid @enderror" name="testresultstatus">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" rows="6" name="testresultcomment" required></textarea>
                                    </div>
                                </div>
                                @error('testresultcomment')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror</div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input class="btn btn" type="file" placeholder="" name="testresultfile"></div>
                                    </div>
                                </div>
                                ...
                                <input id="testresultstart" type="text" name="testresultstart" value="<?php echo $date ?>" hidden>
