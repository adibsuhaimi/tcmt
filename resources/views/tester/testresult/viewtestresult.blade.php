        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <div class="container-fluid" style="width: 1000px;">
                    <h3 class="text-dark mb-4">View Test Result</h3>
                ...
                <div class="container-fluid" style="width: 1000px;">
                    <div class="card shadow mb-5">
                        ...
                        <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group"><label for="testresultreference"><strong>ID</strong></label>
                                        <input id="testresultreference" type="text" class="form-control @error('testresultreference') is-invalid @enderror" name="testresultreference" value="{{ $tr->testresultreference}}" autofocus readonly>
                                    </div>
                                </div></div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <div class="form-group"><label for="testcaseexpresult"><strong>Comment</strong></label>
                                        <textarea readonly class="form-control" rows="6" name="testcaseexpresult">{{ $tr->testresultcomment}}</textarea>
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <a href="{{ asset('uploads/testresultfile/'. $tr->testresultfile) }}">{{ $tr->testresultfile }}</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-header py-3">
                            ...
                            <button class="btn btn-primary" type="button" onclick="document.location='/projects/{{$info->projectid}}'">Back</button>
                        </div>
