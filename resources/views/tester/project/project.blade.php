                                              ...
                                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                @if($tc->id == $data->id)
                                                  @foreach($noresult as $no)
                                                    @if($no->testcaseid == $tc->testcaseid)
                                                      <a class="dropdown-item" href="{{route('testresults.createtr', $tc->testcaseid)}}">Add Test Result</a>
                                                    @endif
                                                  @endforeach
                                                @endif
                                              </div>
                                                ...
                                                <li><span>{{$tr->testresultreference}} &nbsp; {{$tr->testresultstatus}}</span>&nbsp;
                                                  <button class="btn btn-primary" type="button" id="dropdownMenuButton" data-toggle="dropdown">+</button>
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                      ...
                                                      @if($tc->id == $data->id)
                                                        <a class="dropdown-item" href="/testresults/{{$tr->testresultid}}/edit">Update Test Result</a>
                                                        <a class="dropdown-item" href="/testresults/destroy/{{$tr->testresultid}}" onclick="return confirm('Are you sure to delete {{$tr->testresultreference}}?')">Delete Test Result</a>
                                                      @endif
                                                    </div>
