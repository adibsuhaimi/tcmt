        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <div class="container-fluid" style="width: 1000px;">
                    <h3 class="text-dark mb-4">Update Project</h3>
                    <div class="card shadow mb-5">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Project Details</p>
                        </div>
                        <div class="card-body">
                        <form method="post" action="/projects/{{ $project->projectid}}">
                        @csrf
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input id="projectname" type="text" class="form-control @error('projectname') is-invalid @enderror" name="projectname" value="{{ $project['projectname'] }}" autofocus>
                                    </div>
                                </div>
