        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <div class="container-fluid" style="width: 1000px;">
                    <h3 class="text-dark mb-4">Add Test Case</h3>
                    <div class="card shadow mb-5">
                        ...
                        <form method="POST" action="{{ route('testcases.storetc', $info->reqid) }}" enctype="multipart/form-data">
                        @csrf

                                <div class="form-row">
                                <div class="col">
                                        <div class="form-group"><label for="testcasereference"><strong>ID</strong></label>
                                        <input id="testcasereference" type="text" class="form-control @error('testcasereference') is-invalid @enderror" name="testcasereference" value="" autofocus>
                                    ...
                                    <div class="col">
                                        ...
                                        <input id="testcaseexptime" type="text" class="form-control @error('testcaseexptime') is-invalid @enderror" name="testcaseexptime" value="" autofocus>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input id="testcasetitle" type="text" class="form-control @error('testcasetitle') is-invalid @enderror" name="testcasetitle" value="" autofocus>
                                    </div>
                                </div>
                                @error('testcasetitle')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" rows="6" name="testcaseprecondition"></textarea>
                                    </div>
                                </div>
                                @error('testcaseprecondition')
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" rows="6" name="testcasestep"></textarea>
                                    </div>
                                </div>
                                @error('testcasestep')
                                        <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" rows="4" name="testcaseexpresult"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input class="btn btn" type="file" placeholder="" name="testcasefile"></div>
                                    </div>
                                </div>
                                @error('testcasefile')
                                        <span class="invalid-feedback" role="alert">
