    ...
    <div class="container">
      <div class="collapse navbar-collapse" id="example-header-2">
        ...
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item"><b><a class="nav-link" href="/projects/team/{{$req->projectid}}">Team Member</a></b></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <div class="container-fluid" style="width: 1000px;">
                    <h3 class="text-dark mb-4">Update Requirement</h3>
                    <div class="card shadow mb-5">
                        ...
                        @csrf
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input id="reqreference" type="text" class="form-control @error('reqreference') is-invalid @enderror" name="reqreference" value="{{$req->reqreference}}" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input id="reqtitle" type="text" class="form-control @error('reqtitle') is-invalid @enderror" name="reqtitle" value="{{$req->reqtitle}}" autofocus>
                                    </div>
                                </div>
                        ...
                        <div class="card-header py-3">
                            ...
                            <button class="btn btn-danger" type="button" onclick="document.location='/projects/{{$req->projectid}}'">Cancel</button>
                        </div>
                        </form>
                    </div>
                </div>
