        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <div class="container-fluid" style="width: 1000px;">
                    <h3 class="text-dark mb-4">Add Requirement</h3>
                    <div class="card shadow mb-5">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Requirement Details</p>
                        </div>
                        <div class="card-body">
                        <form method="POST" action="{{ route('requirements.storereq', $info->projectid) }}">
                        @csrf
                                <div class="form-row">
                                    <div class="col">
                                        <div class="form-group"><label for="reqreference"><strong>ID</strong></label>
                                        
                                        <input id="reqreference" type="text" class="form-control @error('reqreference') is-invalid @enderror" name="reqreference" value="" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input id="reqtitle" type="text" class="form-control @error('reqtitle') is-invalid @enderror" name="reqtitle" value="" autofocus>
                                    </div>
                                </div>
